...
const greyDefs = (() => {
  ...
  greys.forEach((entry) => {
    result[`grey-${entry}`] =
      `rgb(var(--color-grey-${entry}-raw) / <alpha-value>)`;
  });
...
const rightDefs = (() => {
  ...
  rights.forEach((entry) => {
    result[`right-${entry}`] =
      `rgb(var(--color-right-${entry}-raw) / <alpha-value>)`;
  });
...
const leftDefs = (() => {
  ...
  lefts.forEach((entry) => {
    result[`left-${entry}`] =
      `rgb(var(--color-left-${entry}-raw) / <alpha-value>)`;
  });
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "primary-weblink":
          "rgb(var(--color-primary-weblink-raw) / <alpha-value>)",
        "primary-weblink-hover":
          "rgb(var(--color-primary-weblink-hover-raw) / <alpha-value>)",
        "surface-brand": "rgb(var(--color-surface-brand-raw) / <alpha-value>)",
        "surface-brand-medium":
          "rgb(var(--color-surface-brand-medium-raw) / <alpha-value>)",
        "surface-brand-dark":
          "rgb(var(--color-surface-brand-dark-raw) / <alpha-value>)",
        "surface-brand-secondary-dark":
          "rgb(var(--color-surface-brand-secondary-dark-raw) / <alpha-value>)",
        "surface-brand-tertiary":
          "rgb(var(--color-surface-brand-tertiary-raw) / <alpha-value>)",
        "surface-card-primary":
          "rgb(var(--color-surface-card-primary-raw) / <alpha-value>)",
        header: "rgb(var(--color-text-header-raw) / <alpha-value>)",
        "link-dark": "rgb(var(--color-text-link-dark-raw) / <alpha-value>)",
        "sitecore-highlight-1":
          "rgb(var(--color-bg-sitecore-light-1-raw) / <alpha-value>)",
        "sitecore-highlight-2":
          "rgb(var(--color-bg-sitecore-light-2-raw) / <alpha-value>)",
        "sitecore-secondary-deep-1":
          "rgb(var(--color-bg-sitecore-dark-1-raw) / <alpha-value>)",
        "sitecore-secondary-deep-2":
          "rgb(var(--color-bg-sitecore-dark-2-raw) / <alpha-value>)",
        "black-08": "rgba(var(--color-black-raw) / 0.8)",
        ...greyDefs,
        ...rightDefs,
        ...leftDefs,
        ...systemColorDefs,
      ...
      boxShadow: {
        e0: "0px 0px 4px rgba(0, 0, 0, 0.25)",
